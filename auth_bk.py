...
class Auth:
    ...
    def __init__(self):
        ...
        self.url = 'https://api.real-debrid.com/oauth/v2/device/code?client_id=%s&new_credentials=yes' % (
            self.CLIENT_ID)
    ...
    def authenticate(self):
        ...
        print("Please visit: {} and paste this code {} to authenticate, this code will expire in 5 minutes. ".format(
    ...
    def refresh_authentication(self):
        ...
        self.data = {'client_id': self.jsonfile['client_id'],
